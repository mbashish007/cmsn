    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex justify-content-end mr-5">
                <button class="btn btn-info mr-2 text-white" id="btn-post">Posts</button>
                <button class="btn btn-warning" id="btn-repo">Repos</button>
            </div>
            <div class="mt-2">
                <div id="post-div">
